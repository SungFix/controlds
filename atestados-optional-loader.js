(function initAtestadosOptionalLoader(){
  ...
  function refreshAtestadosFormVisibilityOrder(){
    ...
    if(visibility.getAttribute("href")!=="atestados-form-visibility.css?v=2")visibility.href="atestados-form-visibility.css?v=2";
  ...
  async function loadOptional(){
    ...
    loading=(async()=>{
      ...
      ensureStyle("controlAtestadosFormVisibilityStyles","atestados-form-visibility.css?v=2");
      refreshLightLayers();
