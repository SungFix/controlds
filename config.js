...
(function initControlTheme(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet("controlThemeSecondaryStyles", "theme-light-secondary.css?v=10");
  ...
  function updateButton(button){
    ...
    button.style.background = light ? "#edf3f6" : "#171a1f";
    button.style.color = light ? "#304751" : "#f3f5f7";
    button.style.borderColor = light ? "#c8d8df" : "#39414b";
  }
