...
(function initControlTheme(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet("controlMobileMenuStyles", "mobile-menu-enhance.css?v=4");
    ...
    ensureStylesheet("controlStudentListOrganizerStyles", "student-list-organizer.css?v=1");
    ...
    ensureStylesheet("controlRequestCardLayoutFixStyles", "request-card-layout-fix.css?v=4");
    ...
    ensureStylesheet("controlPortalStyles", "portal.css?v=4");
    ...
    ensureScript("eteUserCapabilitiesScript", "user-capabilities.js?v=2");
    ensureScript("controlProfessorDirectorParityScript", "professor-director-parity.js?v=5");
    ...
    ensureScript("controlUxPrimeScript", "ux-prime.js?v=4");
    ensureScript("controlFinalPolishScript", "final-polish.js?v=5");
    ...
    ensureScript("controlPortalScript", "portal.js?v=18");
