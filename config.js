...
(function initControlTheme(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet("controlVisualStabilityFinalStyles", "visual-stability-final.css?v=2");
    ...
    ensureScript("controlStudentReputationScript", "student-reputation.js?v=3");
    ...
    ensureScript("controlPortalScript", "portal.js?v=8");
