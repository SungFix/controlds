...
(function initControlTheme(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet("controlRequestCardLayoutFixStyles", "request-card-layout-fix.css?v=3");
    ...
    ensureScript("controlRequestSearchPolishScript", "request-search-polish.js?v=1");
