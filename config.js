...
(function initControlTheme(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet("controlThemeSecondaryStyles", "theme-light-secondary.css?v=9");
  ...
  function updateButton(button){
    ...
    button.style.background = light ? "#eef3f6" : "#171a1f";
    button.style.color = light ? "#314751" : "#f3f5f7";
    button.style.borderColor = light ? "#ccdbe2" : "#39414b";
  }
