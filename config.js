...
(function initControlTheme(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet("controlThemeSecondaryStyles", "theme-light-secondary.css?v=2");
  ...
  function updateButton(button){
    ...
    button.style.background = light ? "#dce6eb" : "#171a1f";
    button.style.color = light ? "#2f4651" : "#f3f5f7";
    button.style.borderColor = light ? "#b6c8d1" : "#39414b";
  }
