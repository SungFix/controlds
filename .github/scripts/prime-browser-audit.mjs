...
async function simulateAdmin(page){
  await page.evaluate(()=>{
    ...
    currentUser={username:'adm',displayName:'Auditor',role:'adm',roleLabel:'Administrador',userId:'prime-audit-adm'};
    appReady=true;
    students=[
    ...
    data=[
      normalizeRequest({id:'rq-wait',student:'Ana Beatriz',studentName:'Ana Beatriz',studentClass:'1°A',studentCourse:'DS',studentId:'st-1',room:'1°A DS',reason:'Atividade de programação',startTime:'10:20',endTime:'11:10',time:'10:20–11:10',dateKey:today,status:'wait',requestedBy:'adm',requestedById:'prime-audit-adm',requestedByLabel:'Auditor',createdAt:now}),
      normalizeRequest({id:'rq-use',student:'Lucas Henrique',studentName:'Lucas Henrique',studentClass:'2°B',studentCourse:'EDF',studentId:'st-2',room:'2°B EDF',reason:'Pesquisa escolar',startTime:'08:20',endTime:'09:10',time:'08:20–09:10',dateKey:today,status:'use',code:'123456',requestedBy:'adm',requestedById:'prime-audit-adm',requestedByLabel:'Auditor',createdAt:now,pickedAt:now,pickedBy:'Monitor'}),
      normalizeRequest({id:'rq-done',student:'Ana Beatriz',studentName:'Ana Beatriz',studentClass:'1°A',studentCourse:'DS',studentId:'st-1',room:'1°A DS',reason:'Trabalho em grupo',startTime:'13:00',endTime:'13:50',time:'13:00–13:50',dateKey:today,status:'done',code:'987654321',requestedBy:'adm',requestedById:'prime-audit-adm',requestedByLabel:'Auditor',createdAt:now,returnedAt:now,returnedBy:'Monitor'})
    ];
    permissions=[
