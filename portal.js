(function initCentralPortal(){
  ...
  function ensureAtestadosAssets(callback){
    ...
    if(!roomCss){roomCss=document.createElement("link");roomCss.id="eteAtestadosRoomStyles";roomCss.rel="stylesheet";roomCss.href="atestados-room-picker.css?v=1";document.head.appendChild(roomCss);}
