(function initCentralPortal(){
  ...
  function ensureAtestadosAssets(callback){
    ...
    if(!controlCss){controlCss=document.createElement("link");controlCss.id="eteAtestadosControlLayoutStyles";controlCss.rel="stylesheet";controlCss.href="atestados-control-layout.css?v=3";document.head.appendChild(controlCss);}else if(controlCss.getAttribute("href")!=="atestados-control-layout.css?v=3")controlCss.href="atestados-control-layout.css?v=3";
    let minimalCss=document.getElementById("eteAtestadosMinimalStyles");
    if(!minimalCss){minimalCss=document.createElement("link");minimalCss.id="eteAtestadosMinimalStyles";minimalCss.rel="stylesheet";minimalCss.href="atestados-minimal.css?v=2";document.head.appendChild(minimalCss);}else if(minimalCss.getAttribute("href")!=="atestados-minimal.css?v=2")minimalCss.href="atestados-minimal.css?v=2";
    let roomScript=document.getElementById("eteAtestadosRoomScript");
    if(!roomScript){roomScript=document.createElement("script");roomScript.id="eteAtestadosRoomScript";roomScript.src="atestados-room-picker.js?v=6";roomScript.defer=true;document.head.appendChild(roomScript);}else if(roomScript.getAttribute("src")!=="atestados-room-picker.js?v=6")roomScript.src="atestados-room-picker.js?v=6";
    if(window.ETEAtestados){callback?.();return;}
    let script=document.getElementById("eteAtestadosScript");
    if(!script){script=document.createElement("script");script.id="eteAtestadosScript";script.src="atestados.js?v=6";script.defer=true;script.addEventListener("load",function(){callback?.();},{once:true});document.head.appendChild(script);return;}
    if(script.getAttribute("src")!=="atestados.js?v=6")script.src="atestados.js?v=6";
