(function initCentralPortal(){
  ...
  function ensureAtestadosAssets(callback){
    ...
    if(!roomCss){roomCss=document.createElement("link");roomCss.id="eteAtestadosRoomStyles";roomCss.rel="stylesheet";roomCss.href="atestados-room-picker.css?v=2";document.head.appendChild(roomCss);}else if(roomCss.getAttribute("href")!=="atestados-room-picker.css?v=2")roomCss.href="atestados-room-picker.css?v=2";
