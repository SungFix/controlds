(function initLoginUsability(){
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      html[data-theme="light"] body.auth-locked .login-password-toggle{background:#faf6f0;border-color:#d7cec1;color:#554d45}
      html[data-theme="light"] body.auth-locked .login-password-toggle:hover{background:#eee6db;border-color:#c5b9aa;color:#1b1916}
